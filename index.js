...
// const person : string = "Bushra Mahin";
...
// Task 30
let person = ["admin", "Eric", "Alex"];
for (let index = 0; index < person.length; index++) {
    if (person[index] == "admin") {
        console.log(`Hello ${person[index]}, would you like to see a status report?`);
    }
    else {
        console.log(`Hello ${person[index]}, thank you for logging in again`);
    }
}
